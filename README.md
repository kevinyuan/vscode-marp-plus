...
Also available for Obsidian: [![GitHub](https://img.shields.io/badge/GitHub-marp--tikz--plus-black?logo=github)](https://github.com/kevinyuan/marp-tikz-plus) [![Obsidian Plugin](https://img.shields.io/badge/Obsidian-Marp%20TikZ%20Plus-7c3aed?logo=obsidian)](https://obsidian.md/plugins?id=marp-tikz-plus)
...
**Enjoy building your next deck!** If you encounter issues or have suggestions, please [file an issue on GitHub](https://github.com/kevinyuan/vscode-marp-plus/issues).
